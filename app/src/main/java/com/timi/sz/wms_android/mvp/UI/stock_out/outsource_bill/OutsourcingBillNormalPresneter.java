...
import com.timi.sz.wms_android.mvp.UI.stock_out.outsourcing_audit.OutSourceAuditNormalModel;
 ...
 * $dsc
 * author: timi
 * create at: 2017-11-16 11:20
 */

public class OutsourcingBillNormalPresneter extends MvpBasePresenter<OutsourcingBillNormalView> {
    public OutsourcingBillNormalPresneter(Context context) {
        super(context);
        model=new OutsourcingBillNormalModel();
    }
    ...
    private OutsourcingBillNormalModel model;
